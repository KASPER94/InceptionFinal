...
// /** Database username */
// define( 'DB_USER', getenv('WP_USER_LOGIN') );
...
define( 'DB_NAME', getenv('DB_NAME') ?: 'Inception' );
define( 'DB_USER', getenv('WP_ADMIN_LOGIN') ?: 'Christopher' );
define( 'DB_PASSWORD', getenv('WP_ADMIN_PASSWORD') ?: 'Nolan123' );
define( 'DB_HOST', 'mariadb' );
